...
namespace BudgetAppBackend.Application.Contracts
{
    public interface ITransactionRepository
    {
        ...
        Task<List<Transaction>> GetTransactionsByUserAndCategoryAsync(UserId userId, string category, DateTime budgetCreatedDate, CancellationToken cancellationToken);
