...
namespace BudgetAppBackend.Infrastructure.Migrations
{
    ...
    [Migration("20250306063719_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetAppBackend.Domain.CategoryAggregate.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BudgetAppBackend.Domain.TransactionAggregate.Transaction", b =>
                {
                    b.HasOne("BudgetAppBackend.Domain.CategoryAggregate.Category", null)
                        .WithMany()
